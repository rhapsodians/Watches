...
class ACollectedManScraper(BaseScraper):
    name = "acollectedman"
    _BASE = "https://www.acollectedman.com/search?q={query}&type=product"
        ...
        for card in soup.select("[class*='product'], article, li[class*='item']"):
            try:
                ...
                if not url.startswith("http"):
                    url = "https://www.acollectedman.com" + url
                ...
                logger.debug("acollectedman parse error: %s", e)
        return listings
